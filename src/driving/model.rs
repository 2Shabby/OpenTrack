...
impl Default for DrivingTuning {
    fn default() -> Self {
        Self {
            ...
            passive_slide_yaw_response: 0.0022,
            rear_brake_yaw_assist: 0.0048,
            rear_brake_grip_loss: 0.18,
            drift_min_speed: 14.0,
            drift_min_steer: 0.42,
            drift_min_slip_angle: 0.30,
            slide_saturation_threshold: 1.98,
            slide_speed_threshold: 18.5,
            slide_slip_angle_threshold: 0.92,
        }
    }
}
